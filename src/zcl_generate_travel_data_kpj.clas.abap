CLASS zcl_generate_travel_data_kpj DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_kpj IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_kpj.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_kpj.

*   insert the new table entries
    INSERT ztravel_kpj FROM TABLE @itab.
